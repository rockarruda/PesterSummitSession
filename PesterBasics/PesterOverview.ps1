...
Describe -Name 'TestToken' -Tag 'Unit'{ #This is the describe block which contains a group of tests, and you can also set a tag for ex.. Unit or integrated.
    #Testing the function Get-Token
    Context -Name 'Get-Token' { #This block is used to group a set of tests (It blocks) in the decribe block, use case would be scenarios etc..
